	...
	if(!empty($photo)){
		...
		if($_FILES['photo']['size']<5000000){
			...
			if( in_array(strtolower($photo_ext),$accepted_extension_list) ){
				...
				$_SESSION['about_photo_extension'] = "Attach a jpg,png or jpeg photo";
				header('location: about_me.php');
				ob_end_flush();
			}
			...
			$_SESSION['about_photo_size'] = "Attach a photo under 1MB";
			header('location: about_me.php');
			ob_end_flush();
		}
		...
		// if empty
		$_SESSION['about_photo_emty'] = "Attach a Photo";
		header('location: about_me.php');
		ob_end_flush();
	}
