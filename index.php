...
<head>
        ...
        <title>MD MUSHFIQUR RHMAN</title>
		...
		<!-- CSS here -->
        <link rel="stylesheet" href="front_end_assets/css/rresponsive.min.css">
    ...
    <body class="theme-bg">
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none" ><b>PORTFOLIO</b></a> 
                                    <a href="index.php" class="navbar-brand s-logo-none"><b>PORTFOLIO</b></a>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#service">Interests</a></li>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                        ...
                        <img src="front_end_assets/img/logo/offcanvas_logo.png" alt="" />
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                               ...
                               <a download href="./resume.pdf" class="btn wow fadeInUp" data-wow-delay="1s">DOWNLOAD CV</a>
                            </div>
                        </div>
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="front_end_assets/img/banner/Mushfiq3.png" title="me-01" alt="me-01">
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="section-title text-center mb-70">
                                <span>Interests</span>
                                <h2>Research Topics That I Like</h2>
                            </div>
                        </div>
                    </div>
					<div class="row">
          ...
          ?>
            ...
            <section class="fact-area">
                <div class="container">
                    <div class="fact-wrap">
                        <div class="section-title text-center mb-70">
                    <h3>Statistics of Different Software Projects</h3>
                    </div> 
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                 <!--   <div class="fact-icon">
                                    ...
                                    <img  src="admin/image/logo/web.jpeg" alt="img" width='100'>
                                    <div class="fact-content">
                                        <p><b>Web Applications: <span class="count"><?=$fact_information['feature_item']?></span></b></p>
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                 <!--   <div class="fact-icon">
                                    ...
                                    <img  src="admin/image/logo/androidapp.png" alt="img" width='100'>
                                    <div class="fact-content">
                                        <p><b>Android Applications: <span class="count"><?=$fact_information['feature_item']?></span></b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                 <!--   <div class="fact-icon">
                                    ...
                                    <img  src="admin/image/logo/desktop2.png" alt="img" width='100'>
                                    <div class="fact-content">
                                        <p><b>Desktop Applications: <span class="count"><?=$fact_information['feature_item']?></span></b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                    ...
                                    <img  src="admin/image/logo/ai.png" alt="img" width='100'>
                                    <div class="fact-content">
                                        <p><b>AI Applications: <span class="count"><?=$fact_information['feature_item']?></span></b></p>
                      </div>
            ...
            <div class="barnd-area pt-100 pb-100">
                <div class="container">
                     <div class="section-title text-center mb-70">
                     <span>Skills</span>           
                     <h3>I Know Following Coding Languages</h3>
                            </div>
                    ...
                    echo "At Least Six Logos Are Required";
                }
                  ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© <span><a href="http://localhost/myportfolio/admin/"target="_blank">MD MUSHFIQUR RAHMAN</span> | All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="front_end_assets/js/jkquery.min.js"></script>
