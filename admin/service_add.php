...
<!-- Start Page content -->
 	<div class="card text-dark mb-3" >
	  <div class="card-header text-center "><h2>Research Interests</h2></div>
	  <div class="card-body">

					<form action="" method="post" >
						<div class="form-group">
							<label for="project_name">Interest Topic</label>
							<input type="text" class="form-control" name="title">
						</div>

						<div class="form-group">
							<label for="project_name">N/A</label>
							<input type="text" class="form-control" name="icon">
						</div>

						<div class="form-group">
							<label for="project_catagory">Add Description</label>
							<textarea name="some_text" class="form-control"></textarea>
						</div>

						
						<div class="form-group">
							<input class="btn btn-block" type="submit" value="Add" name="submit">
						</div>
