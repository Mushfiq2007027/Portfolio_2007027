...
<!-- Start Page content -->
                                	...
                                	<div class="row">
                                		...
                                		<div class="col-6">
                                			...
                                			<div class="card">
																	  <div class="card-header  text-center"><h2>Change Data</h2></div>
																	  <!-- card body start  -->
																	  <div class="card-body">
																	  	<form action="about_me_update.php" method="post">
																				...
																				<div class="form-group">
																					<input class="btn btn-block" type="submit" value="Edit Data" name="submit">
																				</div>
                                		...
                                		<!-- data column end -->
				                            ...
				                            <div class="col-4 mx-auto">
				                            	...
				                            	<form action="about_me_update.php" enctype="multipart/form-data" method="post">
																				...
																				<input class="btn btn-block" type="submit" name="photo_submit" value="Change Photo">
