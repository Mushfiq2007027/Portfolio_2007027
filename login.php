...
<head>
     ...
     <!--   <link rel="shortcut icon" href="admin/assets/images/favicon.ico"> -->
        ...
        <!-- App css -->
        <link href="admin/assets/css/design.min.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <h3 style="text-align: center; color: black;">Please Login</h3>
                            ...
                            <!-- password not match -->
                              ...
                              <?php } ?>
                                ...
                                <div class="form-group row text-center m-t-10">
                                    <div class="col-12">
                                        <input class="btn btn-block" type="submit" value="Login" name="login">
                                    </div>
                                </div>
  ...
  <p class="account-copyright"><?=date('Y')?> © MD MUSHFIQUR RAHMAN</p>
            <div class="m-t-40 text-center">
               <span><a href="http://localhost/myportfolio/"target="_blank"><-- Back To Portfolio</span>
            </div>
        ...
        <script src="admin/assets/js/jjquery.bundle.min.js"></script>
