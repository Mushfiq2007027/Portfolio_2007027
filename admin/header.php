...
<head>
      ...
      <!--  <link rel="shortcut icon" href="assets/images/favicon.ico"> -->
       ...
       <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.css">
        ...
        <!-- App css -->
        <link href="assets/css/design.min.css" rel="stylesheet" type="text/css" /> 
                 ...
                 ?>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);"> <span> 3.About me </span></a>
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                  <!--  <span class="badge badge-danger badge-pill float-right">
                                    ...
                                    <span> 5.Interests </span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="services.php"> =>Interests</a></li>
                                    <li><a href="service_add.php"> =>Add Interest</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"> <span> 6.Contact Information</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><span> 8.Statistics</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                  <!--  <span class="badge badge-danger badge-pill float-right">
                                    ...
                                    <span> 9.My Projects</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="best_works.php"> =>My Recent Projects</a></li>
                            ...
                            <li>
                                ...
                                <!--    <span class="badge badge-danger badge-pill float-right">
                                    ...
                                    <span> 11.Skills</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="logo.php"> =>My Skills</a></li>
                                    <li><a href="add_logo.php"> =>Add Skill</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                    ...
                                    <div class="dropdown-item noti-title">
                                        <h6 class="text-overflow m-0">Welcome! Mushfiq</h6>
                                    </div>
